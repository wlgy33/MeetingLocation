...
public class DetailRouteInfo extends Activity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        close.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                hideSoftKeyboard(DetailRouteInfo.this);
                finish();
            }
        });
    ...
    class DetailAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            DetailRouteView  view = null;

            if (convertView == null) {
                view = new DetailRouteView(getApplicationContext());


            } else {
                view = (DetailRouteView) convertView;
            }

            AddressItem item = items.get(position);
            view.setDetailName(item.getName());
            view.setDetailRoute(item.getRoute());
            return view;
        }
    }
}
